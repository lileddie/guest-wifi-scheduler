...
def wifiChecker():
    ssh_session=ConnectHandler(device_type='cisco_wlc_ssh',ip=ssh_ip,username=ssh_username,password=ssh_password)
...
# CHANGE vv to your wlan number.  This can be found from the gui or CLI as show wlan
    ssh_session.send_command("wlan disable 2")
...
# CHANGE vv to your wlan number.  This can be found from the gui or CLI as show wlan
    ssh_session.send_command("wlan enable 2")
    ssh_session.exit_config_mode()
    ssh_session.disconnect()
