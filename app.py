...
def wifiChecker():
    ssh_session=ConnectHandler(device_type='cisco_wlc_ssh',ip='YOUR_IP',username=ssh_username,password=ssh_password)
    text_out=ssh_session.send_command("show wlan 4")[177:236] #NOTE: MODIFY the WLAN number with the correct WLAN - you have been warned.
